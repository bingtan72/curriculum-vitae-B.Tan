...
\cvitem{JNCA}{{Liya Liu}*, \textbf{Bing Tan}, {Sun Young Cho}*. On the resolution of variational inequality problems with a double-hierarchical structure. Submitted to \textit{J. Nonlinear Convex Anal.} 2020, 21(2):}
